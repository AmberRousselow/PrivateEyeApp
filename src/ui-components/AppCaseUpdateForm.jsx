...
import { getAppCase } from "../graphql/queries";
import { updateAppCase } from "../graphql/mutations";
...
export default function AppCaseUpdateForm(props) {
  ...
  React.useEffect(resetStateValues, [appCaseRecord]);
  const validations = {
    title: [],
    description: [],
    createdDateTime: [],
